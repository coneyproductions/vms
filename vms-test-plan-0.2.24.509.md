# VMS Test Plan — 0.2.24.509

## Scope
Band vendor application copy-polish pass on top of 0.2.24.508.
...
3. Confirm **Typical turnout for your shows in this region** is shown for bands only, uses the expected ranges, and becomes required when **Band / Artist** is selected.
