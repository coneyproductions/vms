...
- [x] Current RC built: `dist/wporg-04v/vms-1.0.0-public-release.zip`
...
- Plugin Check was reduced from the `4567`-finding source-tree baseline to `3163` findings on the current packaged RC.
...
- and a narrowed blocker list for the post-`WPORG-04V` follow-up batch.
