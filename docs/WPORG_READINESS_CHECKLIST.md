...
- [x] Plugin Check rerun against a temporary packaged plugin slug under the local WordPress install.
...
- [x] Current RC built: `dist/wporg-04n/vms-1.0.0-public-release.zip`
...
- Plugin Check was reduced from the `4567`-finding source-tree baseline to `3274` findings on the current packaged RC.
...
- and a narrowed blocker list for `WPORG-04O`.
