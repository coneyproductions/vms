...
- [x] Current RC built: `dist/wporg-06c/vms-1.0.0-public-release.zip`
...
- Plugin Check was reduced from the `4567`-finding source-tree baseline to `3076` findings on the current packaged RC.
...
- and a narrowed blocker list plus phased follow-up plan for the post-`WPORG-06C` security and runtime work.
