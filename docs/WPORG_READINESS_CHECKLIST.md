...
- [x] Current RC built: `dist/wporg-09a/vms-1.0.0-public-release.zip`
...
- Plugin Check was reduced from the `4567`-finding source-tree baseline to `3030` findings on the current packaged RC.
...
- and a narrowed blocker list plus phased follow-up plan for the post-`WPORG-09A` security and runtime work.
