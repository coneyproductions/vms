# VMS Test Plan — 0.2.24.623 Progressive Qualified Mobile Copy Polish
...
1. Upload/install `VMS_Ticket_UI_623.zip` on staging.
2. Confirm `vms-build.txt` reports `0.2.24.623`.
3. Confirm the WP plugin header and `VMS_VERSION` constant both report `0.2.24.623`.
...
- On phone widths, the registered-email input and button stack full-width.
