# VMS Test Plan — 0.2.24.627 Registered Guest Mobile Stack Repair

🚨 **Codex/staging verification recommended before live deployment.**

## Version checks

1. Upload/install `VMS_Ticket_UI_627.zip` on staging.
2. Confirm `vms-build.txt` reports `0.2.24.627`.
3. Confirm the WP plugin header and `VMS_VERSION` constant both report `0.2.24.627`.
...
4. Confirm the registered-guest action still says `Add Registered Guest`.
