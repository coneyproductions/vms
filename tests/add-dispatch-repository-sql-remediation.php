...
function bvmgr_add_dispatch_table_name(string $table): string
{
...
$targetFunctions = array(
	'bvmgr_add_dispatch_vendor_previously_contacted',
	'bvmgr_add_dispatch_get_response',
	'bvmgr_add_dispatch_find_response_by_raw_token',
	'bvmgr_add_dispatch_log',
	'bvmgr_add_dispatch_get_request',
	'bvmgr_add_dispatch_get_requests_for_event_plan',
	'bvmgr_add_dispatch_get_recent_requests',
	'bvmgr_add_dispatch_get_responses_for_request',
	'bvmgr_add_dispatch_get_recent_responses_for_event_plan',
	'bvmgr_add_dispatch_create_request',
	'bvmgr_add_dispatch_prepare_resend',
	'bvmgr_add_dispatch_close_request',
	'bvmgr_add_dispatch_record_public_response',
	'bvmgr_add_dispatch_get_portal_interest_response',
	'bvmgr_add_dispatch_pending_portal_interest_count',
	'bvmgr_add_dispatch_get_vendor_portal_interest_rows',
	'bvmgr_add_dispatch_reactivate_portal_interest',
	'bvmgr_add_dispatch_withdraw_portal_interest',
	'bvmgr_add_dispatch_apply_assignment_review',
	'bvmgr_add_dispatch_get_recent_responses',
	'bvmgr_add_dispatch_get_pending_portal_interest_rows',
);
...
$createRequestSource = vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_create_request');
$recordResponseSource = vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_record_public_response');
$reactivateSource = vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_reactivate_portal_interest');
$withdrawSource = vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_withdraw_portal_interest');
$assignSource = vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_apply_assignment_review');
...
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_vendor_previously_contacted'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_response'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_find_response_by_raw_token'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_request'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_requests_for_event_plan'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_recent_requests'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_responses_for_request'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_recent_responses_for_event_plan'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_portal_interest_response'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_pending_portal_interest_count'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_vendor_portal_interest_rows'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_recent_responses'));
eval(vms_test_extract_function($helpersSource, 'bvmgr_add_dispatch_get_pending_portal_interest_rows'));
...
vms_test_assert_same(true, bvmgr_add_dispatch_vendor_previously_contacted(71, 9), 'Previously contacted vendors should return true when the count is positive.');
...
$row = bvmgr_add_dispatch_get_response(14);
...
$rawToken = $publicKey . '.' . bvmgr_add_dispatch_token_signature($publicKey, 31, 44, $createdAt);
$wpdb->get_row_queue[] = array(
...
vms_test_assert_same($wpdb->get_row_queue[0], bvmgr_add_dispatch_find_response_by_raw_token($rawToken), 'Raw-token lookups should return the queued matching response row.');
$prepare = vms_test_last_prepare($wpdb);
...
vms_test_assert_same(array('id' => 55, 'status' => 'active'), bvmgr_add_dispatch_get_request(55), 'Single ADD request reads should return the queued request row.');
$prepare = vms_test_last_prepare($wpdb);
...
$rows = bvmgr_add_dispatch_get_requests_for_event_plan(777, 4);
...
$rows = bvmgr_add_dispatch_get_recent_requests(5);
...
$rows = bvmgr_add_dispatch_get_responses_for_request(88);
...
$rows = bvmgr_add_dispatch_get_recent_responses_for_event_plan(444, 7);
...
bvmgr_add_dispatch_get_portal_interest_response(77, 9, true);
$prepare = vms_test_last_prepare($wpdb);
...
bvmgr_add_dispatch_get_portal_interest_response(77, 9, false);
$prepare = vms_test_last_prepare($wpdb);
...
vms_test_assert_same(7, bvmgr_add_dispatch_pending_portal_interest_count(), 'Pending portal-interest counters should return the queued count.');
$prepare = vms_test_last_prepare($wpdb);
...
vms_test_assert_same(7, bvmgr_add_dispatch_pending_portal_interest_count(), 'Pending portal-interest counters should reuse the request-local cache on subsequent reads.');
...
$rows = bvmgr_add_dispatch_get_vendor_portal_interest_rows(21, 6);
...
$rows = bvmgr_add_dispatch_get_recent_responses(3);
...
$rows = bvmgr_add_dispatch_get_pending_portal_interest_rows(8);
