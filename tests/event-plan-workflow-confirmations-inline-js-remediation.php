...
try {
	...
	foreach (array(
		...
		'This will stop sales and open a refund preflight for all supported event-linked purchases, including tickets, preorders, and add-ons. Refund execution requires your separate acceptance of that preflight.',
