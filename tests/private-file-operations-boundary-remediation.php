...
$streamFunction = $extractFunction($privateFilesSource, 'bvmgr_private_files_stream_path');
$storeFunction = $extractFunction($privateFilesSource, 'bvmgr_private_files_store_validated_upload');
$deleteFunction = $extractFunction($privateFilesSource, 'bvmgr_private_files_delete');
$pathSafeFunction = $extractFunction($privateFilesSource, 'bvmgr_private_files_path_is_safe');
...
$assert(strpos($safetyDownloadFunction, 'vms_private_files_stream_path($path, $name, $mime);') !== false, 'The release-excluded safety prototype should retain its historical helper reference.');
