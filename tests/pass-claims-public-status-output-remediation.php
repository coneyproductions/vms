...
$assert(strpos($passClaimsSource, "vms_pass_claims_render_public_shell(__('Already Claimed', 'backstage-venue-manager'), \$claimed_html);") !== false, 'The already-claimed Pass Claims family should remain on its existing public shell handoff.');
