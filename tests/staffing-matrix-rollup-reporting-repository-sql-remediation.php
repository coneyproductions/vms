...
$expected_t4_inventory = array(
	...
	'includes/admin/staffing.php:bvmgr_staffing_admin_render_rollups_page#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
);
