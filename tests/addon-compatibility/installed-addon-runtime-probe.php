...
$check('public-bvm-identity', defined('BVMGR_VERSION') && (string) BVMGR_VERSION === '1.3.1' && function_exists('bvmgr_core') && in_array('backstage-venue-manager/backstage-venue-manager.php', $activePlugins, true));
