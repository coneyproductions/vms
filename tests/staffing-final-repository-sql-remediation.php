...
$expected_t5_inventory = array(
	...
	'includes/admin/staff-list-columns.php:bvmgr_staff_admin_list_linked_user_id#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
	'includes/admin/staff-user-link.php:bvmgr_staff_user_link_metabox_render#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
	'includes/admin/staff-vendor-link.php:bvmgr_staff_vendor_link_metabox_render#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
	'includes/admin/vendor-staff-link.php:bvmgr_vendor_staff_link_metabox_render#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
	'includes/modules/staff-tasks/generator.php:bvmgr_tasks_collect_upcoming_event_ids#1:WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching',
);
