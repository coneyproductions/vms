<?php
/** Filesystem-only boundary regression; never boots an installed WordPress site. */
if (($argv[1] ?? '') === 'child') {
...
try {
    ...
    echo 'PASS ' . count($cases) . " private filesystem configurations; traversal, aliases and symlink children denied\n";
} finally {
