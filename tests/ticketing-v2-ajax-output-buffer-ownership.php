...
try {
	...
	vms_test_assert_code_contains("bvmgr_ticketing_v2_ajax_send_success(array( 'ok' => true, 'cart_url' => function_exists('wc_get_cart_url') ? wc_get_cart_url() : home_url('/cart/'), 'added_tickets' => \$added_tickets, 'added_addons' => \$added_addons, 'added_extensions' => \$added_extensions, 'added_total' => (\$added_tickets + \$added_addons + \$added_extensions), ));", $atomicBody, 'Atomic add should report ticket, add-on, extension, and combined quantities in the final success response.');
