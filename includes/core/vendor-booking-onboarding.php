...
if (!function_exists('bvmgr_vendor_booking_onboarding_settings_option_key')) {
    function bvmgr_vendor_booking_onboarding_settings_option_key(): string
    {
        return 'vms_vendor_booking_onboarding_settings';
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_plan_meta_key')) {
    function bvmgr_vendor_booking_onboarding_plan_meta_key(): string
    {
        return '_vms_vendor_booking_onboarding_v1';
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_default_settings')) {
    function bvmgr_vendor_booking_onboarding_default_settings(): array
    {
        return array(
            'enabled' => true,
...
if (!function_exists('bvmgr_vendor_booking_onboarding_normalize_settings')) {
    function bvmgr_vendor_booking_onboarding_normalize_settings($raw): array
    {
        $defaults = bvmgr_vendor_booking_onboarding_default_settings();
...
if (!function_exists('bvmgr_vendor_booking_onboarding_get_settings')) {
    ...
    {
        $raw = get_option(bvmgr_vendor_booking_onboarding_settings_option_key(), array());
        return bvmgr_vendor_booking_onboarding_normalize_settings($raw);
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_placeholder_help')) {
    function bvmgr_vendor_booking_onboarding_placeholder_help(): array
    {
        return array(
...
if (!function_exists('bvmgr_vendor_booking_onboarding_get_store')) {
    function bvmgr_vendor_booking_onboarding_get_store(int $plan_id): array
    {
        $plan_id = absint($plan_id);
        if ($plan_id <= 0) {
            return array();
        }
        $raw = get_post_meta($plan_id, bvmgr_vendor_booking_onboarding_plan_meta_key(), true);
        return is_array($raw) ? $raw : array();
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_update_store')) {
    function bvmgr_vendor_booking_onboarding_update_store(int $plan_id, array $store): void
    {
        $plan_id = absint($plan_id);
        if ($plan_id <= 0) {
            return;
        ...
        if (empty($store)) {
            delete_post_meta($plan_id, bvmgr_vendor_booking_onboarding_plan_meta_key());
            return;
        }
        update_post_meta($plan_id, bvmgr_vendor_booking_onboarding_plan_meta_key(), $store);
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_contact_name')) {
    function bvmgr_vendor_booking_onboarding_contact_name(int $vendor_id): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_link_state')) {
    function bvmgr_vendor_booking_onboarding_link_state(int $vendor_id, string $email = ''): array
    {
        $linked_user_id = 0;
...
if (!function_exists('bvmgr_vendor_booking_onboarding_vendor_email')) {
    function bvmgr_vendor_booking_onboarding_vendor_email(int $vendor_id): string
    {
        $keys = function_exists('bvmgr_vendor_user_link_vendor_email_meta_keys')
            ? (array) bvmgr_vendor_user_link_vendor_email_meta_keys()
        ...
        $link_state = bvmgr_vendor_booking_onboarding_link_state($vendor_id, '');
...
if (!function_exists('bvmgr_vendor_booking_onboarding_vendor_type_label')) {
    function bvmgr_vendor_booking_onboarding_vendor_type_label(int $vendor_id): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_format_date')) {
    function bvmgr_vendor_booking_onboarding_format_date(string $ymd): string
    {
        $ymd = trim($ymd);
        if ($ymd === '') {
            return '';
...
if (!function_exists('bvmgr_vendor_booking_onboarding_format_day')) {
    function bvmgr_vendor_booking_onboarding_format_day(string $ymd): string
    {
        $ymd = trim($ymd);
        if ($ymd === '') {
            return '';
...
if (!function_exists('bvmgr_vendor_booking_onboarding_format_time')) {
    function bvmgr_vendor_booking_onboarding_format_time(string $start, string $end = ''): string
    {
        $start = trim($start);
        $end = trim($end);
...
if (!function_exists('bvmgr_vendor_booking_onboarding_portal_url')) {
    function bvmgr_vendor_booking_onboarding_portal_url(int $vendor_id = 0): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_plan_targets')) {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_get_vendor_plan_status')) {
    ...
    {
        $targets = bvmgr_vendor_booking_onboarding_plan_targets($plan_id);
        $assignment = isset($targets[$vendor_id]) && is_array($targets[$vendor_id]) ? $targets[$vendor_id] : array();
        $store = bvmgr_vendor_booking_onboarding_get_store($plan_id);
        ...
        $video_uploaded = $video_required && bvmgr_vendor_booking_onboarding_video_is_live($plan_id);
        $video_submitted = $video_required && !$video_uploaded && bvmgr_vendor_booking_onboarding_video_is_submitted($plan_id);
...
if (!function_exists('bvmgr_vendor_booking_onboarding_set_video_waiver')) {
    function bvmgr_vendor_booking_onboarding_set_video_waiver(int $plan_id, int $vendor_id, bool $waived, int $actor_user_id = 0): void
    {
        $store = bvmgr_vendor_booking_onboarding_get_store($plan_id);
        $entry = isset($store[$vendor_id]) && is_array($store[$vendor_id]) ? $store[$vendor_id] : array();
        ...
        bvmgr_vendor_booking_onboarding_update_store($plan_id, $store);
    }
}

if (!function_exists('bvmgr_vendor_booking_onboarding_resolve_text')) {
    function bvmgr_vendor_booking_onboarding_resolve_text(string $template, array $tokens): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_account_prompt')) {
    function bvmgr_vendor_booking_onboarding_account_prompt(array $link_state): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_build_tokens')) {
    function bvmgr_vendor_booking_onboarding_build_tokens(int $plan_id, int $vendor_id, array $assignment, array $settings): array
    {
        $site_name = wp_specialchars_decode(get_bloginfo('name'), ENT_QUOTES);
        $vendor_name = trim((string) get_the_title($vendor_id));
        $vendor_email = bvmgr_vendor_booking_onboarding_vendor_email($vendor_id);
        $contact_name = bvmgr_vendor_booking_onboarding_contact_name($vendor_id);
        $vendor_type = bvmgr_vendor_booking_onboarding_vendor_type_label($vendor_id);
        ...
        $event_time = bvmgr_vendor_booking_onboarding_format_time($start_time, $end_time);
        ...
        $link_state = bvmgr_vendor_booking_onboarding_link_state($vendor_id, $vendor_email);
        $video_upload_url = bvmgr_vendor_booking_onboarding_portal_url($vendor_id);
        ...
        $base_tokens = array(
            ...
            '{event_date}' => bvmgr_vendor_booking_onboarding_format_date($event_date_raw),
            '{event_day}' => bvmgr_vendor_booking_onboarding_format_day($event_date_raw),
            '{event_time}' => $event_time,
            '{event_url}' => $event_url,
            '{vendor_portal_url}' => bvmgr_vendor_booking_onboarding_portal_url($vendor_id),
        ...
        $base_tokens['{vendor_account_prompt}'] = bvmgr_vendor_booking_onboarding_account_prompt($link_state);
        $base_tokens['{promo_video_script}'] = bvmgr_vendor_booking_onboarding_resolve_text((string) ($settings['promo_video_script'] ?? ''), $base_tokens);
        ...
        if (!empty($assignment['is_headliner']) && !empty($settings['video_soft_requirement'])) {
            ...
            $promo_block = bvmgr_vendor_booking_onboarding_resolve_text($promo_block, $base_tokens);
        }
...
if (!function_exists('bvmgr_vendor_booking_onboarding_signature')) {
    function bvmgr_vendor_booking_onboarding_signature(int $plan_id, int $vendor_id, array $assignment): string
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_touch_vendor_contact_meta')) {
    function bvmgr_vendor_booking_onboarding_touch_vendor_contact_meta(int $vendor_id, string $email, string $subject, int $actor_user_id = 0): void
    {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_send_booked_email')) {
    function bvmgr_vendor_booking_onboarding_send_booked_email(int $plan_id, int $vendor_id, string $reason = 'auto', int $actor_user_id = 0): array
    {
        $plan_id = absint($plan_id);
        ...
        $tokens = bvmgr_vendor_booking_onboarding_build_tokens($plan_id, $vendor_id, $assignment, $settings);
        ...
        bvmgr_vendor_booking_onboarding_log_email('vendor_booked_email', $vendor_email, array(
            'plan_id' => $plan_id,
            'vendor_id' => $vendor_id,
            'reason' => $reason,
            'subject' => $subject,
        ...
        bvmgr_vendor_booking_onboarding_touch_vendor_contact_meta($vendor_id, $vendor_email, $subject, $actor_user_id);
        ...
        $entry['signature'] = bvmgr_vendor_booking_onboarding_signature($plan_id, $vendor_id, $assignment);
...
if (!function_exists('bvmgr_vendor_booking_onboarding_should_process_status')) {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_process_plan')) {
    function bvmgr_vendor_booking_onboarding_process_plan(int $plan_id, string $reason = 'auto', int $actor_user_id = 0, bool $allow_notices = false): array
    {
        $settings = bvmgr_vendor_booking_onboarding_get_settings();
        $results = array(
            'sent' => 0,
        ...
        if (!bvmgr_vendor_booking_onboarding_should_process_status($status, $settings)) {
            return $results;
        }
        ...
        foreach ($targets as $vendor_id => $assignment) {
            ...
            $signature = bvmgr_vendor_booking_onboarding_signature($plan_id, $vendor_id, $assignment);
            $entry = isset($store[$vendor_id]) && is_array($store[$vendor_id]) ? $store[$vendor_id] : array();
            ...
            $result = bvmgr_vendor_booking_onboarding_send_booked_email($plan_id, $vendor_id, $reason, $actor_user_id);
            if (!empty($result['success'])) {
                $results['sent']++;
            } else {
...
if (!function_exists('bvmgr_vendor_booking_onboarding_plan_saved')) {
    function bvmgr_vendor_booking_onboarding_plan_saved(int $plan_id, array $context = array()): void
    {
        $plan_id = absint($plan_id);
        if ($plan_id <= 0) {
            return;
        ...
        bvmgr_vendor_booking_onboarding_process_plan($plan_id, 'auto', $actor_user_id, is_admin());
    }
}
add_action('vms_event_plan_saved', 'bvmgr_vendor_booking_onboarding_plan_saved', 20, 2);

if (!function_exists('bvmgr_vendor_booking_onboarding_schedule_event')) {
    function bvmgr_vendor_booking_onboarding_schedule_event(): void
    {
...
add_action('init', 'bvmgr_vendor_booking_onboarding_schedule_event');

if (!function_exists('bvmgr_vendor_booking_onboarding_send_reminder')) {
    function bvmgr_vendor_booking_onboarding_send_reminder(int $plan_id, int $vendor_id): array
    {
        ...
        $status = bvmgr_vendor_booking_onboarding_get_vendor_plan_status($plan_id, $vendor_id);
        ...
        bvmgr_vendor_booking_onboarding_log_email('vendor_booked_video_reminder', $vendor_email, array(
            'plan_id' => $plan_id,
            'vendor_id' => $vendor_id,
            'subject' => $subject,
        ), $result);
...
if (!function_exists('bvmgr_vendor_booking_onboarding_daily_runner')) {
    function bvmgr_vendor_booking_onboarding_daily_runner(): void
    {
        $settings = bvmgr_vendor_booking_onboarding_get_settings();
        ...
        foreach ((array) $plan_ids as $plan_id) {
            ...
            foreach ($targets as $vendor_id => $assignment) {
                ...
                $status_info = bvmgr_vendor_booking_onboarding_get_vendor_plan_status($plan_id, (int) $vendor_id);
                ...
                if ($send) {
                    bvmgr_vendor_booking_onboarding_send_reminder($plan_id, (int) $vendor_id);
                }
            }
        }
    }
}
add_action('vms_vendor_booking_onboarding_daily', 'bvmgr_vendor_booking_onboarding_daily_runner');
