...
add_action('add_meta_boxes', function () {
    add_meta_box(
        'vms_vendor_defaults',
        __('Pay Structure + Booking Defaults', 'vms'),
...
function vms_render_vendor_defaults_metabox($post)
{
    ...
    <div class="vms-vendor-defaults-ui">
        <div class="vms-vendor-defaults-intro">
            <div>
                <h4 class="vms-vendor-defaults-intro__title"><?php esc_html_e('Event Plan Pay Defaults', 'vms'); ?></h4>
            ...
            <div class="vms-vendor-defaults-intro__pills">
                <span class="vms-pill vms-pill-blue"><?php esc_html_e('Template optional', 'vms'); ?></span>
                <span class="vms-pill vms-pill-green"><?php esc_html_e('Defaults auto-fill Event Plans', 'vms'); ?></span>
                <span class="vms-pill vms-pill-muted"><?php esc_html_e('Existing plans stay unchanged', 'vms'); ?></span>
            </div>
        </div>
        ...
        <div class="vms-vendor-defaults-top-grid">
            <section class="vms-vendor-defaults-card vms-vendor-defaults-card--template">
                <div class="vms-vendor-defaults-card__header">
                    <h4><?php esc_html_e('Reusable Template', 'vms'); ?></h4>
                    <p class="description">
                        <?php esc_html_e(
                ...
                <div class="vms-vendor-defaults-grid vms-vendor-defaults-grid--template">
                    <div class="vms-field vms-field--full">
                        <label for="vms_default_comp_package_id"><?php esc_html_e('Default Template', 'vms'); ?></label>
                        <select id="vms_default_comp_package_id" name="vms_default_comp_package_id">
                            <option value="0"><?php esc_html_e('No template selected', 'vms'); ?></option>
                            <?php foreach ($comp_packages as $pkg) :
                                ...
                                $pkg_scope = ($pkg_venue_id > 0) ? get_the_title($pkg_venue_id) : __('Global', 'vms');
                        ...
                        <div class="vms-help"><?php esc_html_e('This template becomes the starting point for this vendor. The Global Event Plan Defaults below can override it.', 'vms'); ?></div>
                    </div>

                    <div class="vms-field vms-field--full">
                        <label for="vms_create_comp_template_name"><?php esc_html_e('Create New Template from Current Defaults', 'vms'); ?></label>
                        <input type="text" id="vms_create_comp_template_name" name="vms_create_comp_template_name" value="" placeholder="<?php echo esc_attr__('Example: Friday Bonus 150/200/250', 'vms'); ?>">
                        <div class="vms-help"><?php esc_html_e('Enter a name, click Update, and VMS will save the current Global Event Plan Defaults as a new editable template and select it for this vendor.', 'vms'); ?></div>
                    </div>
                </div>

                <div class="vms-template-actions">
                    <button type="button" class="button" id="vms-load-comp-template-btn"><?php esc_html_e('Copy Template Into Vendor Defaults', 'vms'); ?></button>
                    <a href="#" class="button button-secondary" id="vms-edit-comp-template-link"><?php esc_html_e('Edit Selected Template', 'vms'); ?></a>
                </div>
            ...
            <details class="vms-vendor-defaults-card vms-vendor-defaults-card--reference vms-vendor-defaults-details">
                <summary>
                    <span class="vms-vendor-defaults-details__title"><?php esc_html_e('Planning-Only Reference Preferences', 'vms'); ?></span>
                    <span class="vms-vendor-defaults-details__meta"><?php esc_html_e('Not auto-filled into Event Plans', 'vms'); ?></span>
                </summary>
                <div class="vms-vendor-defaults-details__body">
                    ...
                    <div class="vms-vendor-defaults-grid vms-vendor-defaults-grid--reference">
                        <div class="vms-field">
                            <label for="vms_fee_min"><?php esc_html_e('Preferred Flat Fee Min ($)', 'vms'); ?></label>
                        ...
                        <div class="vms-field">
                            <label for="vms_fee_max"><?php esc_html_e('Preferred Flat Fee Max ($)', 'vms'); ?></label>
                            <input type="number" step="0.01" min="0"
                                   id="vms_fee_max"
                                   name="vms_fee_max"
                        ...
                        <div class="vms-field">
                            <label for="vms_min_show_rate"><?php esc_html_e('Minimum Acceptable Show Rate ($)', 'vms'); ?></label>
                            <input type="number" step="0.01" min="0"
        ...
        <section class="vms-vendor-defaults-card vms-vendor-defaults-card--booking">
            <div class="vms-vendor-defaults-card__header">
                <h4><?php esc_html_e('Primary / Headliner Event Plan Defaults', 'vms'); ?></h4>
                <p class="description">
                    <?php esc_html_e(
            ...
            <div class="vms-vendor-defaults-grid vms-vendor-defaults-grid--booking">
                ...
                <div class="vms-field vms-vendor-structure-field" data-show-when-structures="flat_fee,flat_fee_door_split,attendance_bonus">
                    <label for="vms_default_flat_fee_amount"><span id="vms-default-flat-fee-label"><?php echo esc_html(($structure === 'attendance_bonus') ? __('Base Pay ($)', 'vms') : __('Flat Fee ($)', 'vms')); ?></span></label>
                    <input type="number" step="0.01" min="0"
                           id="vms_default_flat_fee_amount"
                           name="vms_default_flat_fee_amount"
                           value="<?php echo esc_attr($flat_fee); ?>">
                    <div class="vms-help<?php echo ($structure === 'attendance_bonus') ? '' : ' vms-hidden'; ?>" id="vms-default-flat-fee-help"><?php esc_html_e('This becomes the guaranteed base pay before any attendance bonus is added.', 'vms'); ?></div>
                </div>

                <div class="vms-field">
                    <label for="vms_default_supporting_flat_fee_amount"><?php esc_html_e('Supporting Act Guaranteed Fee ($)', 'vms'); ?></label>
                    <input type="number" step="0.01" min="0"
                    ...
                    <div class="vms-help"><?php esc_html_e('Auto-fills when this vendor is booked in a supporting lineup slot. Leave blank to require a manual event-level fee.', 'vms'); ?></div>
                </div>
                ...
                <div class="vms-field">
                    <label for="vms_default_commission_percent"><?php esc_html_e('Default Agent Fee %', 'vms'); ?></label>
                    <input type="number" step="0.01" min="0" max="100"
                           id="vms_default_commission_percent"
                           name="vms_default_commission_percent"
                           value="<?php echo esc_attr($comm); ?>">
                    <div class="vms-help"><?php esc_html_e('Leave blank for no default agent fee.', 'vms'); ?></div>
                </div>

                <div class="vms-field">
                    <label for="vms_default_commission_mode"><?php esc_html_e('Agent Fee Mode', 'vms'); ?></label>
                    <select id="vms_default_commission_mode" name="vms_default_commission_mode">
                        <option value="artist_fee" <?php selected($mode, 'artist_fee'); ?>>
                            <?php esc_html_e('Added on top of vendor pay', 'vms'); ?>
                        </option>
                        <option value="gross" <?php selected($mode, 'gross'); ?>>
                            <?php esc_html_e('Based on gross / settlement', 'vms'); ?>
                        </option>
                    </select>
                </div>
            </div>
            ...
            <div class="vms-vendor-defaults-bonus-block<?php echo ($structure === 'attendance_bonus') ? '' : ' vms-hidden'; ?>" id="vms-vendor-defaults-bonus-block">
                <div class="vms-vendor-defaults-bonus-block__header">
                    <h5><?php esc_html_e('Attendance Bonus Setup', 'vms'); ?></h5>
                    <p class="description"><?php esc_html_e('Use this when pay is based on a guaranteed base plus a bonus tied to attendance.', 'vms'); ?></p>
                </div>
                ...
                <div class="vms-vendor-defaults-grid vms-vendor-defaults-grid--bonus">
                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus">
                        <label for="vms_default_attendance_bonus_mode"><?php esc_html_e('Bonus Style', 'vms'); ?></label>
                        <select id="vms_default_attendance_bonus_mode" name="vms_default_attendance_bonus_mode">
                            <option value="" <?php selected($bonus_mode, ''); ?>><?php esc_html_e('Select bonus style', 'vms'); ?></option>
                            <option value="step" <?php selected($bonus_mode, 'step'); ?>><?php esc_html_e('Step', 'vms'); ?></option>
                            <option value="continuous" <?php selected($bonus_mode, 'continuous'); ?>><?php esc_html_e('Continuous', 'vms'); ?></option>
                        </select>
                    </div>

                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus">
                        <label for="vms_default_attendance_bonus_start_count"><?php esc_html_e('Starts After Attendance', 'vms'); ?></label>
                        ...
                        <div class="vms-help"><?php esc_html_e('No bonus is earned until attendance goes above this number.', 'vms'); ?></div>
                    </div>

                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus" data-show-when-mode="step">
                        <label for="vms_default_attendance_bonus_step_size"><?php esc_html_e('Step Size', 'vms'); ?></label>
                        ...
                        <div class="vms-help"><?php esc_html_e('How many additional tickets are needed to earn each bonus step.', 'vms'); ?></div>
                    </div>

                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus" data-show-when-mode="step">
                        <label for="vms_default_attendance_bonus_step_bonus"><?php esc_html_e('Bonus Per Step', 'vms'); ?></label>
                        <input type="number" step="0.01" min="0"
                        ...
                        <div class="vms-help"><?php esc_html_e('The amount added each time a step is reached.', 'vms'); ?></div>
                    </div>

                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus" data-show-when-mode="continuous">
                        <label for="vms_default_attendance_bonus_per_ticket_rate"><?php esc_html_e('Bonus Per Ticket', 'vms'); ?></label>
                        <input type="number" step="0.01" min="0"
                        ...
                        <div class="vms-help"><?php esc_html_e('The amount added for each ticket above the starting count.', 'vms'); ?></div>
                    </div>

                    <div class="vms-field vms-vendor-bonus-field" data-show-when-structure="attendance_bonus">
                        <label for="vms_default_attendance_bonus_max_bonus"><?php esc_html_e('Bonus Cap ($)', 'vms'); ?></label>
                        <input type="number" step="0.01" min="0"
                               id="vms_default_attendance_bonus_max_bonus"
                               name="vms_default_attendance_bonus_max_bonus"
                               value="<?php echo esc_attr($bonus_max); ?>">
                        <div class="vms-help"><?php esc_html_e('Optional. Leave blank if the bonus should keep climbing with attendance.', 'vms'); ?></div>
                    </div>
                </div>
            </div>
        ...
        <details class="vms-vendor-defaults-card vms-vendor-defaults-details">
            <summary>
                <span class="vms-vendor-defaults-details__title"><?php esc_html_e('Per-Venue Event Plan Default Overrides', 'vms'); ?></span>
                <span class="vms-vendor-defaults-details__meta"><?php esc_html_e('Optional', 'vms'); ?></span>
            </summary>
            <div class="vms-vendor-defaults-details__body">
                <p class="description">
                    <?php esc_html_e(
                ...
                <?php if (!empty($venues)) : ?>
                    <div class="vms-vendor-defaults-table-wrap">
                        <table class="widefat striped">
                            <thead>
                                <tr>
                                    <th><?php esc_html_e('Venue', 'vms'); ?></th>
                                    <th><?php esc_html_e('Comp Structure', 'vms'); ?></th>
                                    <th><?php esc_html_e('Flat Fee ($)', 'vms'); ?></th>
                                    <th><?php esc_html_e('Door Split %', 'vms'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="vms_default_comp_by_venue[<?php echo esc_attr((string) $venue_id); ?>][structure]">
                                            <option value="" <?php selected($venue_structure, ''); ?>><?php esc_html_e('Use global', 'vms'); ?></option>
                                            <option value="flat_fee" <?php selected($venue_structure, 'flat_fee'); ?>><?php esc_html_e('Flat Fee Only', 'vms'); ?></option>
                                            <option value="flat_fee_door_split" <?php selected($venue_structure, 'flat_fee_door_split'); ?>><?php esc_html_e('Flat Fee + Door Split', 'vms'); ?></option>
                                            <option value="door_split" <?php selected($venue_structure, 'door_split'); ?>><?php esc_html_e('Door Split Only', 'vms'); ?></option>
                                        </select>
                                    </td>
                                    <td>
                ...
                <?php else : ?>
                    <p class="description"><?php esc_html_e('No venues found yet. Create a venue to configure per-venue vendor defaults.', 'vms'); ?></p>
                <?php endif; ?>
            </div>
        </details>
        ...
        <details class="vms-vendor-defaults-card vms-vendor-defaults-details">
            <summary>
                <span class="vms-vendor-defaults-details__title"><?php esc_html_e('Per-Venue + Day-of-Week Vendor Overrides', 'vms'); ?></span>
                <span class="vms-vendor-defaults-details__meta"><?php esc_html_e('Most specific override layer', 'vms'); ?></span>
            </summary>
            <div class="vms-vendor-defaults-details__body">
                <p class="description">
                    <?php esc_html_e(
                ...
                <?php if (!empty($venues)) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="<?php echo esc_attr($name . '[structure]'); ?>">
                                                <option value="" <?php selected($day_structure, ''); ?>><?php esc_html_e('Use venue/global', 'vms'); ?></option>
                                                <option value="flat_fee" <?php selected($day_structure, 'flat_fee'); ?>><?php esc_html_e('Flat Fee Only', 'vms'); ?></option>
                                                <option value="flat_fee_door_split" <?php selected($day_structure, 'flat_fee_door_split'); ?>><?php esc_html_e('Flat Fee + Door Split', 'vms'); ?></option>
                                                <option value="door_split" <?php selected($day_structure, 'door_split'); ?>><?php esc_html_e('Door Split Only', 'vms'); ?></option>
                                            </select>
                                        </td>
                                        <td>
                    ...
                    <?php endforeach; ?>
                <?php else : ?>
                    <p class="description"><?php esc_html_e('No venues found yet. Create a venue to configure day-of-week vendor overrides.', 'vms'); ?></p>
                <?php endif; ?>
            </div>
        </details>
    </div>
