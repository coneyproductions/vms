...
$external_ticket_url = function_exists('bvmgr_event_plan_get_external_ticket_url')
    ? bvmgr_event_plan_get_external_ticket_url($plan_id)
    : (string) get_post_meta($plan_id, '_vms_external_ticket_url', true);
$external_ticket_provider = function_exists('bvmgr_event_plan_get_external_ticket_provider')
...
$event_relationship = function_exists('bvmgr_event_plan_get_relationship')
    ? bvmgr_event_plan_get_relationship($plan_id)
    : 'serenade_range_produced';
$external_event_producer = function_exists('bvmgr_event_plan_get_external_event_producer')
    ? bvmgr_event_plan_get_external_event_producer($plan_id)
    : (string) get_post_meta($plan_id, '_vms_external_event_producer', true);
$external_event_producer_website = function_exists('bvmgr_event_plan_get_external_event_producer_website')
...
$has_native_ticket_records = function_exists('bvmgr_event_plan_has_native_ticket_records')
