...
<p class="vms-ep-basic-item vms-ep-basic-span">
        <label>
            ...
            <?php esc_html_e('Auto-update title to Primary Vendor', 'vms'); ?>
        </label>
    </p>
    ...
    <div class="description<?php echo checked($auto_title, '1', false) ? ' vms-hidden' : ''; ?>" id="vms_title_lock_note">
        <?php esc_html_e('Auto-title is off. Primary Vendor changes will not update the title unless you confirm.', 'vms'); ?>
    </div>
