...
<section class="vms-collapsible-section" data-section-key="secondary_vendors" data-has-data="<?php echo $vms_secondary_has_data ? '1' : '0'; ?>">
    <button type="button" class="vms-collapsible-toggle" aria-expanded="true">
        ...
        <span class="vms-collapsible-label"><?php esc_html_e('Secondary Vendors', 'backstage-venue-manager'); ?></span>
    ...
    <div class="vms-collapsible-body">
        <h4 id="vms-secondary-vendors" class="vms-collapsible-title vms-collapsible-title--in-body" data-section-key="secondary_vendors" data-section-has-data="<?php echo $vms_secondary_has_data ? '1' : '0'; ?>"><?php esc_html_e('Secondary Vendors', 'backstage-venue-manager'); ?></h4>
