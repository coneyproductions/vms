...
if (!class_exists('VMS_Tours_Compat')) {
	class VMS_Tours_Compat
	{
		...
		public function render_legacy_notice(): void
		{
			...
			echo '<p><strong>' . esc_html__('VMS Guided Tours compatibility notice:', 'vms') . '</strong> ' . esc_html__('legacy tour script handles were detected and deregistered on this VMS screen.', 'vms') . '</p>';
